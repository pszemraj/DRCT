...
> [!IMPORTANT]
> This fork focuses on efficient inference with the `efficient_inference.py` script. The original work can be found at [https://github.com/ming053l/DRCT](https://github.com/ming053l/DRCT)
